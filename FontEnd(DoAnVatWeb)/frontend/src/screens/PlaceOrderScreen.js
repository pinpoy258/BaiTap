        ...
        <div className="row  order-detail">
          ...
          <div className="col-lg-4 col-sm-4 mb-lg-4 mb-5 mb-sm-0">
            <div className="row">
              ...
              <div className="col-md-8 center">
                ...
                <p>Hãng Giao: {cart.shippingAddress.country}</p>
                <p>Hình thức thanh toán:{cart.paymentMethod}</p>
              </div>
            </div>
          </div>
          {/* 3 */}
          <div className="col-lg-4 col-sm-4 mb-lg-4 mb-5 mb-sm-0">
            <div className="row">
              ...
              <div className="col-md-8 center">
                <h5>
                  <strong>Giao Đến</strong>
                </h5>
                <p>
                  Địa Chỉ: {cart.shippingAddress.city},
          ...
          <div className="col-lg-3 d-flex align-items-end flex-column mt-5 subtotal-order">
            <table className="table table-bordered">
              <tbody>
                ...
                <tr>
                  <td>
                    <strong>Phí Giao</strong>
                  </td>
                  <td>{cart.shippingPrice}đ</td>
                </tr>
                <tr>
                  <td>
                    <strong>Phí tax</strong>
                  </td>
